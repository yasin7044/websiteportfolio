...
$(".promo-code-cta").click(function() {
  ...
  $.each(coupons, function(index, value) {
    if (promoCode == index) {
      ...
      var discountValue = value, couponReq = true;
...
$("form#personalInfo").submit((e) => {
  e.preventDefault();
  $("form#personalInfo input#userName").text(this.value).prop("disabled", true);
  $("form#personalInfo input#cont-no").text(this.value).prop("disabled", true);
  $("form#personalInfo input#email").text(this.value).prop("disabled", true);
  $(infoEditBtn).show();
});
