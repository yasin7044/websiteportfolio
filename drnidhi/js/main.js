/** ==========================================================================================
  ...
  Powered by :    Simply Syntax Technologies
...
// ===== 1- Blog slide ==== 
    ...
    $(".content-slide").owlCarousel({  
        loop:true,
        margin:0,
         nav: $('.content-slide').data('nav'),
        dots: $('.content-slide').data('dots'),                     
        autoplay: $('.content-slide').data('auto'),
        smartSpeed: 3000,
        responsive:{
            0:{
                items:1,
...
// ===== 8 - classic-content-slide ==== 

    $(".classic-content-slide").owlCarousel({  
        loop:true,
        margin:0,
        nav: $('.classic-content-slide').data('nav'),
        dots: $('.classic-content-slide').data('dots'),                     
        autoplay: $('.classic-content-slide').data('auto'),
        smartSpeed: 1000,
        responsive:{
            0:{
                items:1,
            ...
            992:{
                items: $('.classic-content-slide').data('item')
            }
        }
    });
